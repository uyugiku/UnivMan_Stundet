...
import com.univman.student.StudentController;
...
//  }
  ...
  public String StudentController.updateForm(Model uiModel) {
  	Authentication auth = SecurityContextHolder.getContext().getAuthentication();
      String name = auth.getName();
      populateEditForm(uiModel, Student.findStudentByMail(name));
      return "students/update";
  }
